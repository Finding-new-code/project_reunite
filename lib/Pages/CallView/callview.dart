      ...
      children: [
        Center(
          child: Row(
            ...
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
             AnimatedStackContainer(height: 100,width: 150,
             children: Expanded(child: RTCVideoView(signalling.localRenderer!,mirror: true,)),),
             AnimatedStackContainer(width: 150, height: 100, children: RTCVideoView(signalling.remoteRenderer!))
            ],
          ),
        ),
       Row(
